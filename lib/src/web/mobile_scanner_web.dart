...
class MobileScannerWeb extends MobileScannerPlatform {
  ...
  Future<MobileScannerViewAttributes> start(StartOptions startOptions) async {
    if (_barcodeReader != null) {
      ...
      // Auto-recover from race condition: if a previous dispose() was not
      // awaited (e.g. Flutter widget dispose), the reader may still be set.
      // Stop it cleanly and continue starting fresh instead of throwing.
      await stop();
    }
